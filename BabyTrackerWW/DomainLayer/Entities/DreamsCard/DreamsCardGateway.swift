...
protocol DreamsCardGateway {
    ...
    func addNewLifeCycle(new lifeCycle: LifeCycle, at date: Date, callback: @escaping (Result<LifeCycle, Error>) -> ())
    func changeLifeCycle(_ lifeCycle: LifeCycle, callback: @escaping (Result<LifeCycle, Error>) -> ())
